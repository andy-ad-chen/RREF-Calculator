...
public class Main {
    public static void main(String[] args) {
        ...
        //  listFloatTypical1.add(5.0f);
        //  listFloatTypical1.add(6.0f);
        //  listFloatTypical1.add(4.0f);
   

        //  listFloatTypical2.add(5.0f);
        //  listFloatTypical2.add(10.0f);
        //  listFloatTypical2.add(3.0f);
        ...
        //  listFloatTypical3.add(4.0f);
        //  listFloatTypical3.add(7.0f);
        //  listFloatTypical3.add(4.0f);
        //  listFloatTypical3.add(6.0f);
        //  listFloatTypical3.add(4.0f);
        ...
        //  typicalCaseRow1 = new Row(6, listFloatTypical1);
        //  typicalCaseRow2 = new Row(6, listFloatTypical2);
        //  typicalCaseRow3 = new Row(6, listFloatTypical3);

        //  typicalTestVals.add(typicalCaseRow1);
        //  typicalTestVals.add(typicalCaseRow2);
        //  typicalTestVals.add(typicalCaseRow3);

        //  testMatrix = new Matrix(typicalTestVals, 6, "myMatrix", "this is a matrix desc");
