...
public class Main {
    public static void main(String[] args) {
        new MatrixReducerApp();
         ...
         typicalCaseRow1 = new Row(4, listFloatTypical1);
         typicalCaseRow2 = new Row(4, listFloatTypical2);
         typicalCaseRow3 = new Row(4, listFloatTypical3);

         typicalTestVals.add(typicalCaseRow1);
         typicalTestVals.add(typicalCaseRow2);
         typicalTestVals.add(typicalCaseRow3);

         testMatrix = new Matrix(typicalTestVals, 4, "myMatrix", "this is a matrix desc");
