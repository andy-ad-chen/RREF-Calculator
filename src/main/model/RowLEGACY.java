...
public class RowLEGACY {
    ...
    public RowLEGACY(int cols, ArrayList<Float> vals) {
        columnNum = cols;
        rowVals = vals;
    }
    ...
    public void sumRow(RowLEGACY secondRow) {
    ...
    // TODO: this method can be replaced if we simply make row an extension of
    // ArrayList

    // TODO: Row should have deep copy method - - ArrayList has clone.
